...
This script will [block](https://help.twitter.com/en/using-twitter/blocking-and-unblocking-accounts) all verified Twitter users. Twitter verified ![8.8] users will no longer be able to view your profile, and they will no longer appear in your feed wall or be able to message you.
